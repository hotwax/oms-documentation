---
description: >-
  The HotWax Commerce Documentation Guidelines provide a comprehensive framework
  for creating clear, consistent, and accessible documentation.
---
...
```html
<div data-gb-custom-block data-tag="embed" data-url='(Youtube URL)'></div> Caption {% raw %}
{%\endembed %}
{% endraw %}
```

<figure><img src="https://github.com/adayush17/oms-documentation/assets/72956835/12002fb7-b3f3-4075-a30f-8f62e7199a24" alt=""><figcaption></figcaption></figure>
