...
| HOLD_PRORD_PHYCL_INV | Retailers can configure settings to make physical inventory unavailable online for pre-order products. The default value for this setting is "true" indicating that it is enabled, in order to disable it, the user need to set it to "false".  | false     |
