...
There is a helper method getAllActivePOForStore which will be invoked from loadPreorderCategoryItems service. Here it checks the PO with future arrival date as estimatedDeliveryDate and quantity as availableToPromise from PreOrderShipmentItem entity.

=== For more details please refer loadPreorderCategoryItems service:
include::../Services/loadPreorderCategoryItems.adoc[leveloffset=+1]
