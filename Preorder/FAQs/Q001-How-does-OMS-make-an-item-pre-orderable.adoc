...
:sourcedir: ../Services
include::{sourcedir}/S001-1-loadPreorderCategoryItems.adoc[leveloffset=+1]
...
include::../Services/S001-2-addCategoryProducts.adoc[leveloffset=+1]

=== These are the technical details to add the item to pre-order category via CSV:
include::../Services/S001-3-importProductCategroyMember.adoc[leveloffset=+1]
