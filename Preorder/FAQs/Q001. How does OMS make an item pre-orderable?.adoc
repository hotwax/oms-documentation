...
:sourcedir: ../Services
include::{sourcedir}/loadPreorderCategoryItems.adoc[leveloffset=+1]
...
include::../Services/addCategoryProducts.adoc[leveloffset=+1]

=== These are the technical details to add the item to pre-order category via CSV:
include::../Services/importProductCategroyMember.adoc[leveloffset=+1]
