...
* HotWax Commerce has [two inventory synchronization jobs](../../retail-operations/workflow/job-workflows/inventory.md) : `Hard Sync` and `Upload Recent Inventory Changes`.
