...
During this time other scheduled occurrences of the queue poller job, Process Bulk Imported Files, may take place, but seeing that there is already an instance of the file processor active, it will cancel itself. In the job manager app this may look like an error that needs to be resolved but is normal behavior.