...
After finishing its run, if the file results in a `Failed` status, or produces `Error Records` your data has not be processed and needs to be retried. To learn more about trouble shooting this please refer to this document. (add link)