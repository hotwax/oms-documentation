...
In this section, administrators can select which variance reasons should be synced to NetSuite. Each variance reason can also have a transfer location linked to it, treating it as a transfer instead of a regular adjustment.
...
Each facility comes in a specific department in NeOptionally,tSuite. Administrators need to map HotWax facilities to NetSuite Department IDs.  
