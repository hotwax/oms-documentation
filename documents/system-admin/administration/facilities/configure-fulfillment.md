...
Configuring the scope of participation of a facility in online fulfillment is made convenient through the `Sell inventory online` card on the facility details page and from the [facility home page](/documents/system-admin/administration/facilities/manage-existing-facilities.md). Retailers can now manage whether a facility will participate in inventory computation for a channel from the `Sell inventory online` card.
