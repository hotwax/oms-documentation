...
| 7              | Update Product Identification Setting |  COMMON_ADMIN   | Allows users to chnage product identifiers setting.|
| 8              | View Import App |  IMPORT_APP_VIEW | Allows users view Import App.|
