...
* **Invalid format for email or external ID** – Verify that the email follows the standard format (for example, `example@domain.com`), and external ID (if used) is unique.
