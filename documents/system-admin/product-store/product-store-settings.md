...
| Setting ID | Name | Description | Impact |
| --- | --- | --- | --- |
| `DEFULT_PKG_BOPIS_ORD` | Default Packaging For Store Pickup Orders | Specifies the default packaging type used for BOPIS orders. | Standardizes packaging for in-store pickups. |
