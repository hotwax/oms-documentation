...
Backorder parking refers to the area that holds the orders for backorder items. These orders are stored in the backorder parking area until they are restocked and prepared for fulfillment. Learn more about [backorder parking](../system-admin/administration/facilities/manage-parkings.md).
...
Learn more about [disabling facilities](../system-admin/administration/facilities/disabling-facilities.md).
...
Learn more about [split shipment](../retail-operations/orders/order-management/update-sales-order.md#allow-splitting).
