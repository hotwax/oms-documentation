...
| `productStoreIds`       | Filter returns for particular product store IDs to generate brand-specific feeds. For example, "WSC_STORE".                                                                           |
...
| `completedDatetime`             | Date and time when the return was completed in HotWax.                                     |
