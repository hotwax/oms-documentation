...
* Step 2: Use the facility IDs returned in the response of the storeLookup API with the [BOPIS Check Inventory](../../hotwax-commerce-api-and-data-feeds/inventory/bopis-check-inventory.md) API to get the facilities having inventory for the product.
