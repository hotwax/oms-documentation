...
* Use the [postcodeLookup](../../hotwax-commerce-api-and-data-feeds/facility/postcode-lookup.md) API to convert the postal code into latitude and longitude coordinates. Learn more about how to use the postCodeLookup API and convert postal codes into latitudes and longitudes.
