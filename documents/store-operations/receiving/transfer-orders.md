...
* Progress bar and badges – a horizontal bar reflects how much of the ordered quantity you have entered. To the right are two numbers: the first shows how many units were received in previous sessions, and the second shows how many were ordered in total (e.g., “0 received 10 ordered”). When your entry equals the ordered quantity, the bar turns green; if the number exceeds the ordered quantity, the bar turns red to highlight a potential error.
