...
* Create sessions wisely. When you’re ready to start, return to the counts list and click START COUNTING to create the first session. Additional sessions can be added via NEW SESSION once counting is in progress.