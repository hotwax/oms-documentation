...
| DAMAGE           | REPORT\_VAR      | Decreases ATP inventory by the rejected quantity. QOH also decreases when `Adjust QOH Along with ATP on Rejection` is enabled. | Shows the product is in stock but damaged and unsellable.                                                 |
