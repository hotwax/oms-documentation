...
4. **Scan or Add the Gift Card Number**: To activate a gift card, store staff can either scan the code using the device scanner or enter the number manually in the input field.
5. **Click the Save Icon**: Once the activation code is added, click the save icon to complete the activation, ensuring the gift card is immediately usable by the customer.
