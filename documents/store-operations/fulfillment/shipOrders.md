...
2. Add [multiple boxes](https://docs.hotwax.co/documents/system-admins/fulfillment/shipping-methods/shipping-box#adding-shipment-boxes-for-specific-carriers) to ship large orders.
