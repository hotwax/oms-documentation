...
Fulfill store-to-store and store-to-warehouse transfers through the Fulfillment App, while fulfilling warehouse-to-store transfers through a Warehouse Management System (WMS). 
