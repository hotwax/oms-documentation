...
To Know more about Brokering [Click Here](https://docs.hotwax.co/user-guides/orders/brokering).
...
To Know more about Gift Card [Click Here](https://docs.hotwax.co/user-guides/business-process-models/giftcardorderslifecycle#digital-gift-cards).
...
To know more about this [Click Here](https://docs.hotwax.co/user-guides/administration/facilities/disabling-facilities).
...
To know more about Inventory configuration [Click Here](https://docs.hotwax.co/user-guides/inventory/inventory-management/inventory-configurations).
...
To know more about Bundle Products [Click Here](https://docs.hotwax.co/deployment-and-configurations/v/shopify/additional-resources/kitproducts).
...
To Know more about Online ATP [Click Here](https://docs.hotwax.co/user-guides/business-process-models/inventorylifecycle#push-online-atp-to-ecommerce).
...
To know more [Click Here](https://docs.hotwax.co/user-guides/orders/bopis-fulfillment-app/packed-order-tab).

### Picker
A picker is a role within the Order Management System (OMS) responsible for order fulfillment tasks, specifically picking items from inventory to fulfill orders. Pickers can be created and assigned roles such as Warehouse pickers to manage picking operations efficiently.
...
To learn more [Click Here](https://docs.hotwax.co/user-guides/orders/pre-orders/purchase-order-uploads)
...
To know more about Split Shipment [Click Here](https://docs.hotwax.co/user-guides/orders/order-management/update-orders#allow-splitting)
