...
Use `generate_BrokeredOrderItemsFeed_Netsuite` for allocations that NetSuite will fulfill. The released connector selects approved items assigned to physical facilities in `NETSUITE_FULFILLMENT`.
