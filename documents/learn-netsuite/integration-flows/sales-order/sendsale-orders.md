---
description: >-
  Learn how send sales orders are processed in HotWax Commerce and synchronized
  to NetSuite.
---
...
The steps discussed in the [synchronization of sales orders from HotWax Commerce to NetSuit](order-approval.md)e are followed to sync send sale orders:
