...
* [Routing Rules](https://docs.hotwax.co/documents/retail-operations/orders/order-routing/routing-rules)  
* [Inventory Rules](https://docs.hotwax.co/documents/retail-operations/orders/order-routing/inventory-rules)  
* [Weeks of Supply Routing](https://docs.hotwax.co/documents/retail-operations/orders/order-routing/weeks-of-supply-routing)  
* [Test Drive](https://docs.hotwax.co/documents/retail-operations/orders/order-routing/test-drive)  
* [Additional Settings](https://docs.hotwax.co/documents/retail-operations/orders/order-routing/additional-settings)  
