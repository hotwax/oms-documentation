...
* [Order Routing App](orders/order-routing/README.md)
  * [Sourcing and inventory availability](orders/order-routing/sourcing/README.md)
    * [Sourcing concepts](orders/order-routing/sourcing/concepts.md)
    * [Inventory channels](orders/order-routing/sourcing/inventory-channels.md)
    * [Threshold rules](orders/order-routing/sourcing/threshold.md)
    * [Safety stock rules](orders/order-routing/sourcing/safety-stock.md)
    * [Store pickup rules](orders/order-routing/sourcing/store-pickup.md)
    * [Shipping rules](orders/order-routing/sourcing/shipping.md)
    * [Product inventory](orders/order-routing/sourcing/inventory.md)
    * [Schedule sourcing rules](orders/order-routing/sourcing/schedule-rules.md)
    * [Sourcing rule examples](orders/order-routing/sourcing/use-cases.md)
