...
{% hint style="success" %} This issue is handled in [Release 5.9.0](https://docs.hotwax.co/integrate-with-hotwax/oms-release-versions/oms-release-versions) {% endhint %}
