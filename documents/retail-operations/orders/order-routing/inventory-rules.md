...
*  **Exclude Facility Group:** Exclude a specific facility group from order allocation. Instead of manually selecting every valid facility group, retailers can exclude the specific group that they don’t want for a particular type of order to be allocated to.
