...
* **Shipment Threshold Value Check:** This feature allows retailers to set a minimum shipment value to prevent splitting orders when the value is too low. It helps avoid the cost of shipping low-value items separately, while still balancing delivery speed and overall shipping efficiency.
