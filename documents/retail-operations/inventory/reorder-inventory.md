...
Reorder Point involves leveraging a dedicated reorder channel within the Order Management System (OMS). This channel operates independently of the primary sales channel and serves solely to trigger reorder reports and manage inventory thresholds. See [Manage inventory channels](../orders/order-routing/sourcing/inventory-channels.md) to create a channel in HotWax Commerce.
