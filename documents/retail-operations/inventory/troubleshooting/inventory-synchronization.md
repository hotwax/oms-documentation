...
2. **Consult the User Manual**
   * Refer to the [HotWax Commerce User Manual](https://docs.hotwax.co/documents/retail-operations/workflow/job-manager) for detailed instructions on setting up the correct file path.
