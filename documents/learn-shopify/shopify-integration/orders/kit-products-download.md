...
After identifying the product type as `MARKETING_PKG_PICK`, HotWax Commerce directly [brokers](../../../../retail-operations/orders/order-routing) the entire kit order to the facility where the inventory is available rather than brokering each component separately.
