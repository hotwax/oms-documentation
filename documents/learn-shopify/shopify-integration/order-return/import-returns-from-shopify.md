...
While processing returns from Shopify, if HotWax Commerce does not have the order being returned, it will automatically import the order from Shopify, linking returns to a sales order for full traceability.
