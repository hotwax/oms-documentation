...
Learn more about how HotWax Commerce helps retailers [manage kit products](https://docs.hotwax.co/documents/learn-netsuite/integration-flows/kit-products) and their components in Shopify and NetSuite if the retailer is not using the Bundles App.
