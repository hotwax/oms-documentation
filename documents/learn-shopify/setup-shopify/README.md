---
description: >-
  Learn how to install HotWax Commerce App to integrate your Shopify store with
  HotWax Commerce's Order Management System
---
...
1. **Create JWT Token:**
   * Navigate to the provided documentation link: [JWT Token Creation Guide](https://app.gitbook.com/s/DVy340gLlDzLzxQzy3ZF/hotwax-commerce-api-and-data-feeds/initial-api-authentication).
...
After the Shopify Shop is verified, further editing can be performed on the [Shopify Shop](integration-mappings/) page
